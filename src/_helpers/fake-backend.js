...
export function configureFakeBackend() {
    let users = [
        ...
        {
            id: 2,
            username: "telephoneoperator",
            password: "telephoneoperator",
            firstName: "Usuario",
            lastName: "Teleoperador",
            role: Role.TelephoneOperator
        },
        {
            id: 3,
            ...
            firstName: "Usuario",
            lastName: "Profesional Sanitario",
            role: Role.HealthProfessional
        }
    ]
